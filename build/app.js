...
var _user$project$Slides$unindent = function (multilineString) {
...
var _user$project$Slides$animationDuration = 2000 * _elm_lang$core$Time$millisecond;
var _user$project$Slides$easingFunction = _elm_community$easing_functions$Ease$inOutBounce;
var _user$project$Slides$slidePixelSize = {height: 700, width: 960};
var _user$project$Slides$windowResize = F2(
	function (m, size) {
		var scale = A2(
			_elm_lang$core$Basics$min,
			_elm_lang$core$Basics$toFloat(size.width) / _user$project$Slides$slidePixelSize.width,
			_elm_lang$core$Basics$toFloat(size.height) / _user$project$Slides$slidePixelSize.height);
		return _elm_lang$core$Native_Utils.update(
			m,
			{scale: scale});
	});
var _user$project$Slides$markdownOptions = _elm_lang$core$Native_Utils.update(
...
var _user$project$Slides$md = function (markdownContent) {
	return {
		content: A3(
			_evancz$elm_markdown$Markdown$toHtmlWith,
			_user$project$Slides$markdownOptions,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_user$project$Slides$unindent(markdownContent))
	};
};
var _user$project$Slides$slideView = function (model) {
	var slideSection = F4(
		function (completion, direction, offset, index) {
			return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_1: A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(offset + ((completion * direction) * 100)),
										'%)'))
							}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_lang$core$Maybe$withDefault,
						_user$project$Slides$md(''),
						A2(_elm_lang$core$Array$get, index, model.slides)).content
					]));
		});
	var _p2 = model.animationStatus;
	if (_p2.ctor === 'Idle') {
		return _elm_lang$core$Native_List.fromArray(
			[
				A4(slideSection, 0, 0, 0, model.currentSlideIndex)
			]);
	} else {
		var _p3 = _p2._0;
		var easedCompletion = _user$project$Slides$easingFunction(_p2._1);
		var direction = (_elm_lang$core$Native_Utils.cmp(_p3, model.currentSlideIndex) > 0) ? -1 : 1;
		var newSlideStartingOffset = -100 * direction;
		return _elm_lang$core$Native_List.fromArray(
			[
				A4(slideSection, easedCompletion, direction, 0, model.currentSlideIndex),
				A4(slideSection, easedCompletion, direction, newSlideStartingOffset, _p3)
			]);
	}
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_1: A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_user$project$Slides$slidePixelSize.width),
									'px')
							},
								{
								ctor: '_Tuple2',
								...
								_1: A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_user$project$Slides$slidePixelSize.height),
									'px')
							},
								{
								ctor: '_Tuple2',
				...
				_user$project$Slides$slideView(model)),
				_elm_lang$html$Html$text(
				function () {
					var _p4 = model.animationStatus;
					if (_p4.ctor === 'Idle') {
						return 'idle';
					} else {
						return A2(
...
var _user$project$Slides$Slide = function (a) {
	return {content: a};
};
var _user$project$Slides$Model = F5(
	function (a, b, c, d, e) {
		return {slides: a, currentSlideIndex: b, animationStatus: c, scale: d, pause: e};
	});
var _user$project$Slides$Pause = {ctor: 'Pause'};
var _user$project$Slides$WindowResizes = function (a) {
	return {ctor: 'WindowResizes', _0: a};
};
var _user$project$Slides$AnimationTick = function (a) {
	return {ctor: 'AnimationTick', _0: a};
};
var _user$project$Slides$Prev = {ctor: 'Prev'};
var _user$project$Slides$Next = {ctor: 'Next'};
var _user$project$Slides$mouseClickDispatcher = function (position) {
	return _user$project$Slides$Next;
};
var _user$project$Slides$Last = {ctor: 'Last'};
var _user$project$Slides$First = {ctor: 'First'};
var _user$project$Slides$keyCodesToMessage = _elm_lang$core$Native_List.fromArray(
	[
		{
		message: _user$project$Slides$First,
		keyCodes: _elm_lang$core$Native_List.fromArray(
			[36])
	},
		{
		message: _user$project$Slides$Last,
		keyCodes: _elm_lang$core$Native_List.fromArray(
			[35])
	},
		{
		message: _user$project$Slides$Next,
		keyCodes: _elm_lang$core$Native_List.fromArray(
			[13, 32, 39, 76, 68])
	},
		{
		message: _user$project$Slides$Prev,
		keyCodes: _elm_lang$core$Native_List.fromArray(
			[8, 37, 72, 65])
	},
		{
		message: _user$project$Slides$Pause,
		keyCodes: _elm_lang$core$Native_List.fromArray(
			[80])
	}
	]);
var _user$project$Slides$Noop = {ctor: 'Noop'};
var _user$project$Slides$keyPressDispatcher = F2(
	function (keyCodeMap, keyCode) {
		...
		while (true) {
			...
			if (_p5.ctor === '::') {
				var _p6 = _p5._0;
				if (A2(_elm_lang$core$List$member, keyCode, _p6.keyCodes)) {
					return _p6.message;
				} else {
					var _v5 = _p5._1,
						_v6 = keyCode;
				...
				var x = A2(_elm_lang$core$Debug$log, 'aa', keyCode);
				return _user$project$Slides$Noop;
			}
		}
	});
var _user$project$Slides$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$keyboard$Keyboard$ups(
				_user$project$Slides$keyPressDispatcher(_user$project$Slides$keyCodesToMessage)),
				_elm_lang$mouse$Mouse$clicks(_user$project$Slides$mouseClickDispatcher),
				_elm_lang$window$Window$resizes(_user$project$Slides$WindowResizes),
				_elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Slides$AnimationTick)
			]));
};
var _user$project$Slides$Transitioning = F2(
	function (a, b) {
		return {ctor: 'Transitioning', _0: a, _1: b};
	});
var _user$project$Slides$Idle = {ctor: 'Idle'};
var _user$project$Slides$init = function (slides) {
	var cmd = A3(
		_elm_lang$core$Task$perform,
		function (_p7) {
			return _user$project$Slides$Noop;
		},
		_user$project$Slides$WindowResizes,
		_elm_lang$window$Window$size);
	var model = A5(
		_user$project$Slides$Model,
		_elm_lang$core$Array$fromList(slides),
		0,
		_user$project$Slides$Idle,
		1.0,
		false);
	return {ctor: '_Tuple2', _0: model, _1: cmd};
};
var _user$project$Slides$animate = F2(
	function (m, deltaTime) {
		if (m.pause) {
			return m;
		} else {
			var _p8 = m.animationStatus;
			if (_p8.ctor === 'Idle') {
				return m;
			} else {
				var _p9 = _p8._0;
				var newCompletion = _p8._1 + (deltaTime / _user$project$Slides$animationDuration);
				return (_elm_lang$core$Native_Utils.cmp(newCompletion, 1) > -1) ? _elm_lang$core$Native_Utils.update(
					m,
					{currentSlideIndex: _p9, animationStatus: _user$project$Slides$Idle}) : _elm_lang$core$Native_Utils.update(
					m,
					{
						animationStatus: A2(_user$project$Slides$Transitioning, _p9, newCompletion)
					});
			}
		}
	});
var _user$project$Slides$update = F2(
	function (message, oldModel) {
		...
		var selectSlide = function (newIndex) {
			var newIndex = A3(
				_elm_lang$core$Basics$clamp,
				0,
				_elm_lang$core$Array$length(oldModel.slides) - 1,
				newIndex);
			var newModel = _elm_lang$core$Native_Utils.update(
				oldModel,
				{
					animationStatus: A2(_user$project$Slides$Transitioning, newIndex, 0)
				});
			return noCmd(
				(_elm_lang$core$Native_Utils.eq(newIndex, oldModel.currentSlideIndex) || (!_elm_lang$core$Native_Utils.eq(oldModel.animationStatus, _user$project$Slides$Idle))) ? oldModel : newModel);
		};
		var _p10 = message;
		switch (_p10.ctor) {
			case 'Noop':
			...
			case 'Last':
				return selectSlide(99999);
			case 'Prev':
				return selectSlide(oldModel.currentSlideIndex - 1);
			case 'Next':
				return selectSlide(oldModel.currentSlideIndex + 1);
			case 'WindowResizes':
				return noCmd(
					A2(_user$project$Slides$windowResize, oldModel, _p10._0));
			case 'AnimationTick':
				return noCmd(
					A2(_user$project$Slides$animate, oldModel, _p10._0));
			default:
				return noCmd(
					_elm_lang$core$Native_Utils.update(
						oldModel,
						{
							pause: _elm_lang$core$Basics$not(oldModel.pause)
						}));
		}
	});
var _user$project$Slides$program = function (slides) {
	return {
		init: _user$project$Slides$init(slides),
		update: _user$project$Slides$update,
		view: _user$project$Slides$view,
		subscriptions: _user$project$Slides$subscriptions
	};
};
var _user$project$Slides$app = function (slides) {
	return _elm_lang$html$Html_App$program(
		_user$project$Slides$program(slides));
};

var _user$project$Main$main = {
	main: _user$project$Slides$app(
		_elm_lang$core$Native_List.fromArray(
			[
